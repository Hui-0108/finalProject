	...
	<div class="body-main">
		...
		<table class="table table-content">
			...
			<tr>
				...
				<td>
					<p>
						<input type="password" name="userPwd" maxlength="15" class="boxTF lg"
							placeholder="패스워드">
					</p>
			...
			<tr>
				...
				<td>
					<p>
						<input type="password" name="userPwdCheck" maxlength="15" class="boxTF lg"
							placeholder="패스워드 확인">
					</p>
			...
			<tr>
				...
				<td>
					<p>
						...
						<span>@</span> 
						<input type="text" name="email2" maxlength="30" class="boxTF md" value="${dto.email2}" 
								readonly="readonly">
					</p>
				</td>
			</tr>
