					...
					<div class="nino-menuItem pull-right">
						<div class="collapse navbar-collapse pull-left" id="nino-navbar-collapse">
							<ul class="nav navbar-nav">
								...
								<li><a href="#nino-story">Statistics</a></li>
								<li><a href="#nino-services">Donation</a></li>
								<li><a href="#nino-ourTeam">PetSitter</a></li>
								<li><a href="#nino-portfolio">Store</a></li>
								<li><a href="#nino-latestBlog">Contact</a></li>
							</ul>
						</div><!-- /.navbar-collapse -->
