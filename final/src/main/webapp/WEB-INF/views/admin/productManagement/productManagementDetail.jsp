...
<table style="margin: 10px auto 20px; width: 100%; border-spacing: 1px; background: #ccc">
	<tr class="detail detail-top">
		...
		<td align="left" width="35%" style="padding-left: 5px;"><span>${dto.pNum}</span></td>
		<td align="right" width="15%" style="padding-right: 7px;"><label style="font-weight: 900;">상품명</label></td>
<td align="left" width="35%" style="padding-left: 5px;"><span>${dto.pName}</span></td>
	</tr>
	<tr class="detail detail-top">
		...
		<td align="right" style="padding-right: 9px;"><label style="font-weight: 900;">할인율</label></td>
		<td align="left" style="padding-left: 5px;">
			<input type="text" id="pDiscountRate" name="pDiscountRate" class="boxTF" value="${dto.pDiscountRate}">
		</td>
	</tr>
	<tr class="detail detail-top">
		<td align="right" style="padding-right: 9px;"><label style="font-weight: 900;">배송조건</label></td>
		<td align="left" width="35%" style="padding-left: 5px;"><span>${dto.delivType}</span></td>
		<td align="right" style="padding-right: 9px;"><label style="font-weight: 900;">등록일</label></td>
		<td align="left" width="35%" style="padding-left: 5px;"><span>${dto.pDate}</span></td>
	</tr>
	<tr class="detail detail-top">
		<td align="right" style="padding-right: 9px;"><label style="font-weight: 900;">재고수량</label></td>
		<td align="left" style="padding-left: 5px;">
			<input type="text" id="pDetailCnt" name="pDetailCnt" class="boxTF" value="${dto.pDetailCnt}">
		</td>
		<td align="right" style="padding-right: 9px;"><label style="font-weight: 900;">옵션추가가격</label></td>
		<td align="left" style="padding-left: 5px;">
