...
<table style="margin: 10px auto 20px; width: 100%; border-spacing: 1px; background: #ccc">
	<tr class="detail detail-top">
		...
		<td align="left" width="35%" style="padding-left: 5px;"><span>${dto.mId}</span></td>
		<td align="right" width="15%" style="padding-right: 7px;"><label style="font-weight: 900;">고객번호</label></td>
		<td align="left" width="35%" style="padding-left: 5px;"><span>${dto.mNum}</span></td>
	</tr>
	<tr class="detail detail-top">
		<td align="right" style="padding-right: 9px;"><label style="font-weight: 900;">이름</label></td>
		<td align="left" style="padding-left: 5px;"><span>${dto.mName}</span></td>
		<td align="right" style="padding-right: 9px;"><label style="font-weight: 900;">생년월일</label></td>
		<td align="left" style="padding-left: 5px;"><span>${dto.mBirth}</span></td>
	</tr>
	<tr class="detail detail-top">
		<td align="right" style="padding-right: 9px;"><label style="font-weight: 900;">전화번호</label></td>
		<td align="left" style="padding-left: 5px;"><span>${dto.mTel}</span></td>
		<td align="right" style="padding-right: 9px;"><label style="font-weight: 900;">이메일</label></td>
		<td align="left" style="padding-left: 5px;"><span>${dto.mEmail}</span></td>
	</tr>
	<tr class="detail detail-top">
		<td align="right" style="padding-right: 9px;"><label style="font-weight: 900;">회원가입일</label></td>
		<td align="left" style="padding-left: 5px;"><span>${dto.createdDate}</span></td>
		<td align="right" style="padding-right: 9px;"><label style="font-weight: 900;">최근로그인</label></td>
		<td align="left" style="padding-left: 5px;"><span>${dto.lastLogin}</span></td>
	</tr>
...
<div id="memberStateDetail" style="display: none;"> ${dto.mId}
	<table style="margin: 10px auto 5px; width: 100%; border-spacing: 1px; background: #ccc">
		...
		<c:forEach var="vo" items="${listState}">
			<tr height="30" align="center" bgcolor="#fff">
				<td align="left" style="padding-left: 5px;">${vo.memo} (${vo.msCode})</td>
				<td>${vo.registerId}</td>
